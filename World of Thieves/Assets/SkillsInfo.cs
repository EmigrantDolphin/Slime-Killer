...
public class SkillsInfo {
    ...
    //Slime hand attack
    public const float Slime_HandDamage = 5f;

    //Slime jump attack
    public const float Slime_JumpAttackDamage = 20f;

    //Slime pulse attack
    public const float Slime_PulseDamage = 50f;

    public const float Slime_ForceOrbDamage = 70f;
    ...
    public const float Player_ChannelHeat_Damage = 10f;
